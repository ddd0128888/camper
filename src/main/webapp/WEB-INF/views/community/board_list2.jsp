...
<%
	...
	StringBuffer sbHtml = new StringBuffer();
		for( BoardTO to : boardLists2 ) {
			...
			sbHtml.append( "		<li class='list-inline-item'>by <a href data-toggle='modal' data-target='#userprofile' onclick='userProfile("+'"'+nick+'"'+")'>" + nick + "</a></li>" );
			...
			<div class="row">
				<div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0">
					...
					<%
						...
						out.println( "<li class='page-item'><a class='page-link' href='/community/camptip.do?cpage=1' aria-label='DNext'><span aria-hidden='true'><i class='fa fa-angle-double-left'></i></span><span class='sr-only'>DPrevious</span></a></li>" );
						...
						out.println( "<li class='page-item'><a class='page-link' href='/community/camptip.do?cpage="+listTO.getTotalPage()+"' aria-label='Next'><span aria-hidden='true'><i class='fa fa-angle-double-right'></i></span><span class='sr-only'>DNext</span></a></li>" );
					%>
						</ul>
					</nav>
				</div>
