				...
				<div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0">
					...
					<form action="/community/deleteOk.do" method="post" name="dfrm">
						...
						<input type="hidden" name="boardType" value="<%=type %>" />
							<div class="container">
									<input type="button" value="목록" class="btn btn-transparent" style="float: left;" onclick="goList('<%=type %>');" />
								<div style="float: right;">
									<c:if test="${to.nick eq sessionScope.nick }">
										...
										<input type="button" value="삭제" id="dbtn" class="btn btn-transparent" onclick="location.href='/community/delete.do?pseq=<%=pseq %>&type=<%=type %>'" />
									</c:if>
								</div>
							</div>
						</div>
