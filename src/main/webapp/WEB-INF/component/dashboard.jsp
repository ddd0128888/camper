...
<script type="text/javascript">
	window.addEventListener('load', function() {
		$.ajax({
			url: '/dashboard/totalWrite.do',
			type: 'POST',
			success: function( data ) {
					$( "#totalWrite" ).text( data );
			},
			error: function() {
				console.log( "ajax 에러" )
			}
...
<body>
	...
	<div class="widget user-dashboard-menu">
		<ul>
			...
			<li class="${param.thisPage eq 'jjim' ? 'active' : '' }"><a href="/dashboard/jjim.do"><i class="fa fa-bookmark"></i> 찜한 갬핑장 <span>2</span></a></li>
			<li class="${param.thisPage eq 'write' ? 'active' : '' }"><a href="/dashboard/write.do"><i class="fa fa-pencil"></i> 내가 쓴 글 <span id = "totalWrite">2</span></a></li>
			...
			<li class="${param.thisPage eq 'message' ? 'active' : '' }"><a href="/message_list.do"><i class="fa fa-comments"></i>메세지함</a></li>
			<li class="${param.thisPage eq 'question' ? 'active' : '' }"><a href="/dashboard/question.do"><i class="fa fa-question-circle"></i> 1:1 문의</a></li>
